...
%%
dF = F_to_dF (F(:, :, :, 2, :), base_range, base_type, dF_type, peak_range, sumF_range) ;
%%
...
saveas( gcf, strcat('M102D_0617_2kHz_', Bin_type, '_',dF_type, '_dF',' base_type_', base_type,'_Att_', attL, ...
