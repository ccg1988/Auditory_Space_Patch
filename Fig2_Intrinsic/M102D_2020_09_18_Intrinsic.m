% Right Hemisphere, Face Door
clear;clc
close all
load('M102D_2020_09_18_R_mean.mat')
ID = 'All' ;
att_level = 40 ;
[X_pix, Y_pix, ~] = size(R_mean); 
S1 = 24 ;         % 24 or 32 spks or sound frequency or SN
...
axis('equal'); axis off
colormap(c); caxis([1 S1]); %---for spatial tuning curve under single level with all reps
title(['Attenuation: ', num2str(att_level), ' dB   threshold with peak \DeltaF/F >',num2str(100*deltaF_threshold), '%']);
saveas(gcf, strcat('M102D_2020_09_18_winner_take_all_', num2str(deltaF_threshold*100), ...
...
saveas(gcf, strcat('M102D_2020_09_18_Tuning full  SRF thre_', num2str(SRF_thres), '%_TV thre_', num2str(TV_thres),...
...
saveas(gcf, strcat('M102D_2020_09_18_azimuth_elevation', '.png')); 