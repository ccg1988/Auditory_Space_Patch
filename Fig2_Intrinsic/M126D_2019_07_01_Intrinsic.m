...
clear;clc
close all
load('M126D_2019_07_01_R_mean.mat')
ID = 'All' ;
att_level = 40 ;
...
deltaF_threshold = 0.025 ; % 0.03 for dF max peak, 0.2 for dF summed area
...
saveas(gcf, strcat('M126D_2019_07_01_R_winner_take_all_', num2str(deltaF_threshold*100), ...
    '%_',ID, '_att_', num2str(att_level), 'dB.png'));
%%
% compute the azimuth and elevation---SLOW!
spont_rate = 0;
load('Speakers_32_LH_BD.mat') %speaker info, for 102D, right hemisphere and face door
...
saveas(gcf, strcat('M126D_2019_07_01_Tuning full  SRF thre_', num2str(SRF_thres), '%_TV thre_', num2str(TV_thres),...
...
saveas(gcf, strcat('M126D_2019_07_01_azimuth_elevation', '.png'));